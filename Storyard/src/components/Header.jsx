    ...
    <div className='max-w-[100vw]'>
        ...
        <div className="flex flex-col items-center justify-center w-full md:flex-row md:w-2/3">
            <div className="max-w-xl px-8">
                <h1 className="text-3xl font-medium tracking-wide text-white md:text-4xl">The Best Story Reading and Writing Platform</h1>
                <p className="mt-4 text-gray-400">Welcome to Storyard: Where imagination meets storytelling. Explore, create, and share your tales with our vibrant community. Join us on a journey through boundless creativity and let the world know your stories.</p>
                <div className="mt-6">
